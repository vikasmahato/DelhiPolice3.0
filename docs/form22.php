  ...
  <body style='margin-left:2cm'>
    ...
    <script src='js/bootstrap.min.js'></script>
      <div class='container'>
        ...
        <div style='text-align:justify;margin-top:10px;'>No._________ / Genl. Br. (SED) dated New Delhi, ____________/$date</div>
         <div style='margin-top:5px;'>To</div>
        <div><div style='margin-left:100px;'>The Medical Superintendent,</div>
        <div style='margin-left:100px;'>$value[hospital_name]</div>
        ...
        <div>
          ...
          <td style='text-align:justify;'>Regarding to provide credit facility for the treatment of $string1 $value[rank] $value[applicant_name], No. $value[police_station_no] (PIS $value[pis])</td>
          </tr>
          </table>
        </div>

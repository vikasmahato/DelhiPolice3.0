  ...
  <body style='margin-left:2cm'>
    ...
    <script src='js/bootstrap.min.js'></script>
      <div class='container'>
          ...
          <td style='text-align:justify;'>Dairy No. $value[diary_no] / Genl. Br. (SED) dated $value[diary_date]</td>
          </tr>
          <tr>
          <td style='vertical-align:top'>Subject:-</td>
          <td style='text-align:justify;'>Regarding reimbursement of Medical Claim in respect of<b> $value[rank] $value[applicant_name] No. $value[police_station_no]</b></td>
          </tr>
          </table>
        </div>
        ...
        <div style='text-align:left;text-decoration:underline;font-weight:bold;margin-top:25px;'>HAG</div>
     ...
     <div style='text-align:left;text-decoration:underline;font-weight:bold;margin-top:25px;'>HAG/SE</div>
        <div style='text-align:left;text-decoration:underline;font-weight:bold;margin-top:5px'>INSPR. ADMIN.</div>
